...
def generate_model():
    ...
    json_file = open("./DECISION_AEC/modelo_outrun_ae.json", 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = tf.keras.models.model_from_json(loaded_model_json)
    model.load_weights("./DECISION_AEC/modelo_outrun_ae.hdf5")
...
def retrain_and_do_all_on_server(server_ip='192.168.132.1:5000'):
    ...
    if info_text['Message'] == 'Model Trained.':
        ...
        open('./DECISION_AEC/modelo_outrun_ae.hdf5', 'wb').write(r.content)
